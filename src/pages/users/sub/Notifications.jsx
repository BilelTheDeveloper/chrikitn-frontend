...
const Notifications = () => {
  ...
  // 1. Fetch Transmissions (Pending Missions)
              ...
              >
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-xl bg-amber-500/10 flex items-center justify-center border border-amber-500/20 overflow-hidden">
                        {mission.sender?.identityImage ? (
                           <img 
                            // ✅ UPDATED: Uses centralized getImageUrl from config
                            src={getImageUrl(mission.sender.identityImage)} 
                      ...
                      <div>
                        <h3 className="text-sm font-black uppercase tracking-tight text-white">
                          Briefing: {mission.relatedPost?.title || "Operational Intel"}
                        </h3>
                        <p className="text-[10px] text-amber-400 font-bold uppercase tracking-widest">
                          From Operative: {mission.sender?.name || "Unknown"}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-3 bg-black/30 p-4 rounded-xl border border-white/5">
                    <div>
                      ...
                      <p className="text-xs text-slate-200 leading-relaxed font-medium">
                        {mission.globalMissionObjective}
                      </p>
                    </div>
                    <div>
                  ...
                  <div className="flex gap-3 pt-2">
                    <button 
                      onClick={() => handleDecision(mission._id, 'accept')}
                    ...
                    <button 
                      onClick={() => handleDecision(mission._id, 'reject')}
